...
public class NameTags extends Module {
	...
	private final Setting scale = new Setting.Builder(SettingType.INTEGER).setName("Scale").setModule(this)
			.setIntegerValue(36).setMinIntegerValue(1).setMaxIntegerValue(100).build();

	private final Setting gamemode = new Setting.Builder(SettingType.BOOLEAN).setName("Gamemode").setModule(this)
			.setBooleanValue(true).build();

	private final Setting health = new Setting.Builder(SettingType.BOOLEAN).setName("Health").setModule(this)
			.setBooleanValue(true).build();

	private final Setting ping = new Setting.Builder(SettingType.BOOLEAN).setName("Ping").setModule(this)
			.setBooleanValue(true).build();

	private final Setting rainbowOutline = new Setting.Builder(SettingType.BOOLEAN).setName("RainbowOutline")
			.setModule(this).setBooleanValue(true).build();

	public NameTags(String name, String description, Category category) {
