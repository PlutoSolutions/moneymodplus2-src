...
public class InteractUtil {
	...
	private static float[] getLegitRotations(Vec3d var0) {
		...
		return new float[] {
				Minecraft.getMinecraft().player.rotationYaw
						+ MathHelper.wrapDegrees(var10 - Minecraft.getMinecraft().player.rotationYaw),
				Minecraft.getMinecraft().player.rotationPitch
						+ MathHelper.wrapDegrees(var11 - Minecraft.getMinecraft().player.rotationPitch) };
	}
	...
	public static void faceVectorPacketInstant(Vec3d var0) {
		...
		Minecraft.getMinecraft().player.connection
				.sendPacket(new net.minecraft.network.play.client.CPacketPlayer.Rotation(var1[0], var1[1],
	...
	public static List getSphere(BlockPos var0, float var1, int var2, boolean var3, boolean var4, int var5) {
		...
		for (int var10 = var7 - (int) var1; (float) var10 <= (float) var7 + var1; ++var10) {
			for (int var11 = var9 - (int) var1; (float) var11 <= (float) var9 + var1; ++var11) {
				for (int var12 = var4 ? var8 - (int) var1 : var8; (float) var12 < (var4 ? (float) var8 + var1
						: (float) (var8 + var2)); ++var12) {
					double var13 = (double) ((var7 - var10) * (var7 - var10) + (var9 - var11) * (var9 - var11)
							+ (var4 ? (var8 - var12) * (var8 - var12) : 0));
					if (var13 < (double) (var1 * var1)
							&& (!var3 || var13 >= (double) ((var1 - 1.0F) * (var1 - 1.0F)))) {
	...
	private static void processRightClickBlock(BlockPos var0, EnumFacing var1, Vec3d var2) {
		getPlayerController().processRightClickBlock(Minecraft.getMinecraft().player, mc.world, var0, var1, var2,
				EnumHand.MAIN_HAND);
	}
	...
	public static void placeBlockScaffold(BlockPos var0) {
		Vec3d var1 = new Vec3d(Minecraft.getMinecraft().player.posX,
				Minecraft.getMinecraft().player.posY + (double) Minecraft.getMinecraft().player.getEyeHeight(),
				Minecraft.getMinecraft().player.posZ);
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			if (canBeClicked(var6)) {
				Vec3d var8 = (new Vec3d(var6)).add(0.5D, 0.5D, 0.5D)
						.add((new Vec3d(var7.getDirectionVec())).rotatePitch(0.5F));
	...
	public static void lookAtBlock(BlockPos var0) {
		rotate(calculateLookAt((double) var0.getX(), (double) var0.getY(), (double) var0.getZ(),
